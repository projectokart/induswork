  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <a href="/" className="mt-6 inline-block bg-orange text-white px-5 py-2 rounded-lg font-bold">Go home</a>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <button onClick={() => { router.invalidate(); reset(); }} className="mt-5 bg-orange text-white px-5 py-2 rounded-lg font-bold">Try again</button>
      </div>
    </div>
  );
}
